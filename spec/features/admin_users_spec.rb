...
feature 'admin users controller' do
  ...
  context 'on index page' do
    ...
    scenario "don't lock my account", js: true do
      visit admin_users_path
      page.find_link(admin_user.name).trigger(:mouseover)
  ...
  scenario 'edit user info', js: true do
  ...
  # context 'on show page' do
    # scenario 'lock user account', js: true
    # scenario 'delete user account', js: true
    # scenario "don't delete my account", js: true
    # scenario 'render detail user info', js: true
    # scenario 'update user account', js: true
    # scenario 'user account', js: true
  # end
